// ***** ------ SUMMON FAMILIAR ------ ***** //
  ...
  // *** --- SUMMON FAMILIAR -- *** //
    ...
    function summonBossFamiliar() {
      ...
      console.log("BOSS STRENGTH: " + strength + ", " + "BOSS HEALTH: " + health + ", " + "BOSS STAMINA: " + stamina + ", " + "BOSS MAGIC: " + magic + ", " + "UNDEAD: " + undead + ".");

      var newBossFamiliar = new familiar(description, monsterType, monsterClass, strength, health, stamina, magic);
